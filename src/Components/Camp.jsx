  ...
  return (
    <section className="2xl:max-container relative flex flex-col py-20 lg:mb-10 lg:py-20 xl:mb-20">
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5x1 xl:px-16 xl:py-20 w-full overflow-hidden relative rounded-3xl">
        <h2 className="regular-24 md:regular-32 2xl:regular-64 capitalize text-white"><strong>Feeling Lost</strong> And Not Knowing The Way?</h2>
          ...
          <Image src="/quote.svg" alt="camp2" width={186} height={219} className="camp-quote" />
        </div>
      </div>
    </section>
  )
