    ...
    return (
      <section className="flexCenter flex-col">
        ...
        <div className="flexCenter max-container relative w-full">
          <Image src="/boat.png" alt='boat' width={1140} height={580} className='w-full object-cover 2xl:rounded-5xl' />
          ...
          <Image src="meter.svg" alt='meter' width={16} height={158} className='h-full w-auto' />
            <div className="flexBetween flex-col">
              ...
              <div className="flex w-full flex-col">
                  ...
                  <h4 className='bold-20 mt-2 whitespace-nowrap'>Wonorejo Pasuruant</h4>
              </div>
            </div>
          </div>
        </div>
