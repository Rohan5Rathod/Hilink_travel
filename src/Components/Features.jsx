    ...
    return (
     <section className="flex-col flexCenter overflow-hidden bg-feature-bg bg-center bg-no-repeat py-24">
      <div className="max-container padding-container relative w-full flex justify-end">
        <div className="flex flex-1 lg:min-h-[900px]"><Image src="/phone.png" alt='phone' width={440} height={1000} className='feature-phone' /></div>
        ...
        <ul className='mt-10 grid gap-10 md:grid-cols-2 lg:mt-20 lg:gap-20'>{FEATURES.map((feature)=>(
  ...
  const FeatureItem = ({title, icon, description}) => {
    return(
      <li className='flex w-full flex-1 flex-col items-start'>
       <div className="bg-green-50 p-4 lg:p-7 rounded-full"><Image src={icon} alt='icon' width={28} height={28}/></div>
